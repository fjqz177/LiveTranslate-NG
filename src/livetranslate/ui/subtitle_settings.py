...
from livetranslate.ui.subtitle_window import DEFAULT_SUBTITLE_WIN_SETTINGS
...
class LineEditDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        btn_row = QHBoxLayout()
        btn_row.addStretch()
        ok_btn = QPushButton(t("common_ok"))
...
class SubtitleSettingsWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        self._bg_color_controls = [
            self._bg_color_label,
            self._bg_color_btn,
            self._bg_opacity_label_title,
        ...
        self._click_through_check.setChecked(self._settings.get("click_through", False))
